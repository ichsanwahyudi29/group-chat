...
gulp.task('color', function() {
  gulp
    .src('../user_unify/scss/variables/color.scss')
...
gulp.task('compile-unf-scss', function() {
  ...
  gulp
    .src([
      '../user_unify/scss/dialog.scss',
      '../user_unify/scss/Button.scss',
      '../user_unify/scss/Tooltip.scss',
      '../user_unify/scss/Textfield.scss',
...
gulp.task('compile-unf-js', function() {
  gulp
    .src([
      '../user_unify/js/Dialog.js',
      '../user_unify/js/Input.js',
      '../user_unify/js/Validate.js',
      '',
    ])
...
gulp.task('script', function() {
  gulp
    .src(['src/js/script.js', 'src/js/unf.js'])
...
gulp.task('build', function(callback) {
  runSequence('clean:dist', ['useref', 'css', 'vendor', 'script'], callback);
});
